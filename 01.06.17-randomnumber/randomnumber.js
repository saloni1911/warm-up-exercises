// https://gist.github.com/kasun-maldeni/7c2f3758c7618ad6c9bcc74a23b4c98d/
...
var startUpIdea = function () {
	var randomChoice1 = thisArray[Math.floor(Math.random() * thisArray.length)];
	var randomChoice2 = thatArray[Math.floor(Math.random() * thatArray.length)];
	console.log(randomChoice1 + " , " + randomChoice2);
};
// startUpIdea();

var input = prompt("Do you want to generate a new idea");
if (input === "yes") {
	startUpIdea();
} else {
	alert("Make choices between yes or no, otherwise come back whenever you want to generate one");
}
